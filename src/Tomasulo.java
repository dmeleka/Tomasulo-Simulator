...
//        Memory[100]=55.0;
        ...
        while(!checkComplete()) {
            execute();
            issue(instructions);
            System.out.println(ANSI_RED + "At cycle #"+numberOfCycles++ + ANSI_RESET);
            
            // Register File
            System.out.println(ANSI_YELLOW + "-------------------------" + ANSI_RESET);
               System.out.printf("%6s %6s %9s", "Name", "QI", "Value");
               System.out.println();
               System.out.println(ANSI_YELLOW + "-------------------------" + ANSI_RESET);
               // iterates over the list   
               for (Register j : registerFile) {
                   System.out.format("  %-4s     %-2s     %-8s", j.getName(), j.getqI(), j.getValue());
                   System.out.println();
               }
               System.out.println(ANSI_YELLOW + "-------------------------" + ANSI_RESET);
               ...
               System.out.printf("%5s %10s %9s %7s %7s %7s %7s %11s", "Tag", "Opcode", "Busy", "VJ", "VK", "QJ", "QK", "Cycles");
               System.out.println();
               System.out.println(ANSI_GREEN + "------------------------------------------------------------------------" + ANSI_RESET);
               // iterates over the list   
               for (reservationStation j : AddRS) {
            	   if(j.isBusy()) {
                   System.out.format("  %-3s     %-6s      %-5s     %-5s   %-5s   %-3s     %-3s     %-3s", j.getTag(), j.getOp(), j.isBusy(), j.getvJ(), j.getvK(), j.getqJ(),
                           j.getqK(), j.getCyclesRemaining());
                   System.out.println();
            	   }
            	   else {
                       System.out.format("  %-3s", j.getTag());
                       System.out.println();
            	   }
               }
               System.out.println(ANSI_GREEN + "------------------------------------------------------------------------" + ANSI_RESET);
               ...
               System.out.printf("%5s %8s %11s %10s", "Tag", "Busy", "Address", "Cycles");
               System.out.println();
               System.out.println(ANSI_PURPLE + "---------------------------------------" + ANSI_RESET);
               // iterates over the list   
               for (reservationStation j : LoadRS) {
            	   if(j.isBusy()) {
                   System.out.format("  %-3s     %-6s   %-5s       %-3s", j.getTag(), j.isBusy(), j.getAddress(), j.getCyclesRemaining());
                   System.out.println();
            	   }
            	   else {
                       System.out.format("  %-3s", j.getTag());
               ...
               System.out.printf("%5s %8s %11s %5s %5s %10s", "Tag", "Busy", "Address", "V", "Q", "Cycles");
               System.out.println();
               System.out.println(ANSI_BLUE + "---------------------------------------------------" + ANSI_RESET);
               // iterates over the list   
               for (reservationStation j : StoreRS) {
            	   if(j.isBusy()) {
                   System.out.format("  %-3s     %-6s   %-5s       %-5s %-3s   %-3s", j.getTag(), j.isBusy(), j.getAddress(), j.getvJ(), j.getqJ(),
                           j.getCyclesRemaining());
                   System.out.println();
            	   }
            	   else {
                       System.out.format("  %-3s", j.getTag());
...
//        System.out.println("Memory[100] = " + Memory[100]);
    }
}